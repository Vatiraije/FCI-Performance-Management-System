...
CREATE TABLE `employeerecord` (
  ...
  `hire_date` varchar(225) DEFAULT NULL,
  `manager_id` varchar(225) DEFAULT NULL,
  `job_title` varchar(225) DEFAULT NULL,
  `Kpis` varchar(225) DEFAULT NULL,
  `employeeScore` varchar(225) DEFAULT NULL,
...
-- Dump completed on 2023-10-31  4:27:57
